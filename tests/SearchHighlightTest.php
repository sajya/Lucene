...
class SearchHighlightTest extends TestCase
{
    ...
    public function testHtmlFragmentHighlightMatches(): void
    {
...
//    }
    ...
    public function testHighlightPhrasePlusTerm(): void
    {
        $query = Search\QueryParser::parse('title:"The Right Way" AND text:go');
    ...
    public function testHighlightMultitermWithProhibitedTerms(): void
    {
    ...
    public function testHighlightWildcard1(): void
    {
    ...
    public function testHighlightWildcard2(): void
    {
        $query = Search\QueryParser::parse('te?t*');
    ...
    public function testHighlightFuzzy2(): void
    {
    ...
    public function testHighlightRangeInclusive(): void
    {
    ...
    public function testHighlightRangeNonInclusive(): void
    {
        $query = Search\QueryParser::parse('{business TO by}');
