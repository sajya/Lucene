 ...
 */
class SegmentInfoTest extends TestCase
{
    ...
    public function testOpenCompoundFile(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
        $segmentInfo = new Index\SegmentInfo($directory, '_1', 2);
    ...
    public function testCompoundFileLength(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
        $segmentInfo = new Index\SegmentInfo($directory, '_1', 2);
    ...
    public function testGetFieldNum(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
        $segmentInfo = new Index\SegmentInfo($directory, '_1', 2);
    ...
    public function testGetFieldInfos(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
        $segmentInfo = new Index\SegmentInfo($directory, '_1', 2);
    ...
    public function testGetTermInfo(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
        $segmentInfo = new Index\SegmentInfo($directory, '_1', 2);
    ...
    public function testTermFreqs(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
        $segmentInfo = new Index\SegmentInfo($directory, '_1', 2);
    ...
    public function testNormVector(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
        $segmentInfo = new Index\SegmentInfo($directory, '_1', 2);
    ...
    public function testTermStreamStyleReading(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
    ...
    public function testTermStreamStyleReadingSkipTo(): void
    {
        $directory = new Directory\Filesystem(__DIR__ . '/_source/_files');
