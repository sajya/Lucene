...
abstract class AbstractSimilarity
{
     ...
     * @return float
     */
    public static function decodeNorm($byte): float
    {
     ...
     * @return integer
     */
    public static function encodeNorm($f): int
    {
     ...
     * @return float
     */
    private static function _floatToByte($f): ?float
    {
     ...
     */
    public function idf($input, SearchIndexInterface $reader): ?float
    {
        if (!is_array($input)) {
