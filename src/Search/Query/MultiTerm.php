...
class MultiTerm extends AbstractQuery
{
     ...
     *
     * @param array $terms Array of \Sajya\Lucene\Index\Term objects
     ...
     * @return void
     */
    public function addTerm(Index\Term $term, $sign = null): void
    {
...
// Term is optional or prohibited
     ...
     * @param SearchIndexInterface $reader
     */
    private function _calculateConjunctionResult(SearchIndexInterface $reader): void
    {
     ...
     * @param SearchIndexInterface $reader
     */
    private function _calculateNonConjunctionResult(SearchIndexInterface $reader): void
    {
        $requiredVectors = [];
        ...
        foreach ($this->_terms as $termId => $term) {
            ...
            } else if ($this->_signs[$termId] === false) {
                // prohibited
                // array union
                $prohibited += $termDocs;
            } else {
     ...
     * @return float
     */
    public function _nonConjunctionScore($docId, $reader): float
    {
        if ($this->_coord === null) {
            $this->_coord = [];
