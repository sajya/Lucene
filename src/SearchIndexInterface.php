...
interface SearchIndexInterface extends Index\TermsStreamInterface
{
    ...
    /**
     * Returns the Sajya\Lucene\Storage\Directory\DirectoryInterface instance for this index.
     *
     ...
     *
     * @return boolean
     * @throws ExceptionInterface    Exception is thrown if $id is out of the range
     */
