...
class HTML extends Document
{
     ...
     * @return boolean
     */
    public static function getExcludeNoFollowLinks(): bool
    {
     ...
     * @return HTML
     */
    public static function loadHTML($data, $storeContent = false, $defaultEncoding = ''): HTML
    {
     ...
     * @return HTML
     */
    public static function loadHTMLFile($file, $storeContent = false, $defaultEncoding = ''): HTML
    {
     ...
     * @internal
     */
    public function applyColour($stringToHighlight, $colour): string
    {
    ...
    public function highlightExtended($words, callable $callback, array $params = [])
    {
        ...
        $wordsToHighlight = array_merge(...$wordsToHighlightList);
